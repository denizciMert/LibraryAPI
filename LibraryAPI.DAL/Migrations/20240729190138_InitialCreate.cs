        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorFullName = table.Column<string>(type: "Nvarchar(1000)", nullable: false),
                    Biography = table.Column<string>(type: "Nvarchar(1000)", nullable: true),
                    DateOfBirth = table.Column<short>(type: "smallint", nullable: false),
                    DateOfDeath = table.Column<short>(type: "smallint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LanguageCode = table.Column<string>(type: "Varchar(3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShelfCode = table.Column<string>(type: "Varchar(6)", nullable: false),
                    CreationDateLog = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDateLog = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDateLog = table.Column<DateTime>(type: "datetime2", nullable: true),
                    State = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PenaltyName = table.Column<string>(type: "varchar(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShiftType = table.Column<string>(type: "varchar(20)", nullable: false),
                    CreationDateLog = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDateLog = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDateLog = table.Column<DateTime>(type: "datetime2", nullable: true),
                    State = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TitleName = table.Column<string>(type: "varchar(100)", nullable: false),
                    CreationDateLog = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDateLog = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDateLog = table.Column<DateTime>(type: "datetime2", nullable: true),
                    State = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Isbn = table.Column<string>(type: "Varchar(13)", nullable: true),
                    BookTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PageCount = table.Column<short>(type: "smallint", nullable: false),
                    DateOfPublish = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EducationDegree = table.Column<string>(type: "varchar(50)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorBooks", x => new { x.BooksId, x.AuthorsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookLanguages", x => new { x.BooksId, x.LanguagesId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LoanedMemberId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EmployeeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BookId = table.Column<int>(type: "int", nullable: false),
                    CopyNo = table.Column<short>(type: "smallint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Loans_Members_LoanedMemberId",
                        column: x => x.LoanedMemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PenaltiedMembeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Penalties_Members_PenaltiedMembeId",
                        column: x => x.PenaltiedMembeId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookLanguages_LanguagesId",
                table: "BookLanguages",
                column: "LanguagesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Loans_LoanedMemberId",
                table: "Loans",
                column: "LoanedMemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Penalties_PenaltiedMembeId",
                table: "Penalties",
                column: "PenaltiedMembeId");
